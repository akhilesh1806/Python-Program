# In Priya's restaurant, a waiter is training. Since the waiter isn't good at arithmetic,
# sometimes he gives guests wrong change. Priya gives him a simple problem. What is A-B (A minus B) ?
#
