...
if __name__ == '__main__':
    acc = BankAccount('Akhilesh', 'Santoshwar')
    ...
    # acc.fullName = 'Akhilesh Santoshwar'    #This throws an error! Hence setter decorator should be used.
    acc.fullName = 'Rajendra Santoshwar'
    print(acc.fullName)
